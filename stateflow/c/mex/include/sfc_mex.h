...
#define ALL_WORKSPACES   3
    ...
    typedef void (*DebuggerSimStatusListenerFcn)(struct SfDebugInstanceStruct*, unsigned int);
    typedef void (*DebuggerContextMessageFcnType)(struct SfDebugInstanceStruct*, char *);
...
#define SF_DUPLICATE_ARRAY
    ...
    */
    ...
    extern void sf_set_error_debugger_context_message_fcn(DebuggerContextMessageFcnType debuggerContextMessageFcn, struct SfDebugInstanceStruct* debugInstance);
    extern void sf_set_debugger_matlab_error_fcn(void (*debuggerMatlabErrorFcn)(struct SfDebugInstanceStruct*, char*));

    extern char * sf_get_error_prefix_string(void);
    extern void sf_mex_size_one_check(boolean_T aCondition, const char *aName);
    ...
    extern mxArray *sf_mex_decode_encoded_mx_cell_array(const char *encStr[], int len, int segSize);
    ...
    int64_T sf_mex_lw_bounds_check_int64(int64_T indexValue,int firstIndex,int lastIndex);
#endif
...
#define sf_assertion_msg(expr,msg) ((expr)?(void)0:sf_assertion_failed(#expr,__FILE__,__LINE__,msg))
    ...
    extern void sf_mex_overflow_error(void);
    extern void sf_mex_dividebyzero_error(void);
    extern void sf_mex_unsafe_enum_error(void);
    ...
    bool sf_mex_emlrt_context_is_debug_mode(void);
    void sf_mex_emlrt_context_set_debug_mode(bool b);

    void sf_mex_emlrtNameCapturePostProcessR2012a(const mxArray **mxInfo);
