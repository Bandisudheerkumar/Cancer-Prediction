...
extern "C" {
    ...
    void sf_update_buildInfo(SimStruct *S,
                                       const char* spec,
                                       mxArray *infoStruct,
                                       unsigned int chartFileNumber);
    ...
    extern unsigned int sf_mex_listen_for_ctrl_c(struct SfDebugInstanceStruct* debugInstance, SimStruct *S);
    ...
    extern void sf_call_output_fcn_disable(SimStruct *S,
                                           ...
                                           const char *eventName,
                                           int checkForInitialization);
    void sf_set_rtw_dwork_info(SimStruct *S, const char* spec, mxArray *infoStruct,unsigned chartFileNumber);
